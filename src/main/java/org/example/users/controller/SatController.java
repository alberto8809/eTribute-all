...
import org.example.users.model.SatClass;
import org.example.users.service.SatService;
...
public class SatController {
    ...
    public ResponseEntity<ArrayList<String>> sat(@RequestBody SatClass userSat) throws  IOException {
